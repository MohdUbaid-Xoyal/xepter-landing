...
import { termsMeta } from '@/src/data/terms-of-service-content';
        ...
        <div className="space-y-6 text-center">
          ...
          <div className="space-y-4">
            <TextReveal delay={0.3}>
              <h1 className="mx-auto max-w-[700px]">Terms of Service</h1>
            </TextReveal>
            <TextReveal delay={0.4}>
              <p className="text-background-14/60 mx-auto max-w-[600px]">
                Last Updated and Effective Date: {termsMeta.effectiveDate}
              </p>
            </TextReveal>
          </div>
        </div>
